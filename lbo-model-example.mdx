...
4. `getFinancials`  
   Pull company financials to sanity-check FCF drivers and base metrics.
5. `getHistoricalPrices` / `getPriceSnapshot`  
   Get pricing data for comps or current market context to inform exit multiple selection.
