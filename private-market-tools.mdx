...
description: 'Private company data and funding information via Crunchbase API'
---
...
- **Comprehensive Company Profiles**: Access detailed information about private companies including funding history, team size, and business description
- **Real-Time Funding Data**: Track recent funding rounds with filtering by investment type and timeframe  
- **Investor Intelligence**: Identify key investors and funding patterns in specific sectors
- **Flexible Search**: Search by company name or domain for maximum flexibility
- **Rich Metadata**: Get location, category, social network, and operational status information