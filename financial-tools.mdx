...
### `getHistoricalFinancialMetrics`
Get historical financial metrics for a ticker, including valuation, profitability, efficiency, liquidity, leverage, growth, and per-share metrics.

<Accordion title="View Parameters & Response">

**Parameters:**
```json title="getHistoricalFinancialMetrics - Request"
{
  "ticker": "string (required) - Stock ticker symbol",
  "period": "enum<string> (required) - 'annual' | 'quarterly' | 'ttm'",
  "limit": "integer (default: 4) - Number of periods to return",
  "report_period": "string (optional) - Exact report period date (YYYY-MM-DD)",
  "report_period_lte": "string (optional) - Latest report period on or before date (YYYY-MM-DD)",
  "report_period_lt": "string (optional) - Latest report period before date (YYYY-MM-DD)",
  "report_period_gte": "string (optional) - Earliest report period on or after date (YYYY-MM-DD)",
  "report_period_gt": "string (optional) - Earliest report period after date (YYYY-MM-DD)"
}
```

**Response:**
```json title="getHistoricalFinancialMetrics - Response"
{
  "ticker": "AAPL",
  "period": "annual",
  "financial_metrics": [
    {
      ...
      "price_to_book_ratio": 35.2,
      "price_to_sales_ratio": 7.1,
      "enterprise_value_to_ebitda_ratio": 18.7,
      ...
      "return_on_equity": 0.435,
      "return_on_assets": 0.096,
      "return_on_invested_capital": 0.215,
      "asset_turnover": 1.12,
      "inventory_turnover": 35.8,
      "receivables_turnover": 15.2,
      "days_sales_outstanding": 24.0,
      "operating_cycle": 42.0,
      ...
      "book_value_per_share": 4.75,
      "free_cash_flow_per_share": 5.25
    }
  ],
  "count": 4
}
