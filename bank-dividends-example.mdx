...
description: 'Equity research task building a commercial bank DDM using an operating model and Excel tools'
---
...
![Terminal Value (Growth Method)](/images/bank-dividends/ddm-terminal-value.png)
